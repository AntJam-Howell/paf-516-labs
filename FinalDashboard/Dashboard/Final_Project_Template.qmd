...
```{r}
#| label: map-lisa
#| title: "Hardship Clusters: Maricopa County (LISA)"
#| fig-height: 7
ggplot(change_df) +
  ...
  labs(
    ...
    subtitle = "Statistically significant spatial concentration of economic hardship",
    caption  = paste0(
...
#| content: valuebox
list(
  title = "Hot Spot Tracts — High Economic Hardship Clusters",
  value = n_hh,
  icon  = "fire",
  color = "danger"
)
...
#| content: valuebox
list(
  title = "Cold Spot Tracts — Low Economic Hardship Clusters",
  value = n_ll,
  icon  = "snow",
  color = "primary"
)
...
#| content: valuebox
list(
  title = "Global Moran's I — Spatial Clustering Strength",
