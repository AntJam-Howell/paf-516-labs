...
#| content: valuebox
list(
  title = "Hot Spot Tracts Statewide — High Economic Hardship Clusters (HH)",
  value = paste0(az_n_hh, " Tracts"), icon = "fire", color = "danger"
)
```
...
list(
  ...
  value = paste0(az_n_ll, " Tracts"), icon = "snow", color = "primary"
)
```
