...
library(viridis); library(patchwork); library(biscale); library(tigris); library(DT); library(mapgl); library(glue)
library(scales)
```
...
::: {.card}
### Highest Economic Hardship: Arizona Counties
...
cat(glue::glue(
  ...
  Economic Hardship Index: <strong>{az_top$Hardship}</strong> &nbsp;|&nbsp;
...
::: {.card}
### Lowest Economic Hardship: Arizona Counties
...
cat(glue::glue(
  ...
  {az_bottom$County}</p>
  <p style="font-size:0.88rem;color:#555;margin:2px 0">
  Economic Hardship Index: <strong>{az_bottom$Hardship}</strong> &nbsp;|&nbsp;
...
ggplot(local_2023) +
  ...
  scale_fill_viridis_c(option="inferno", direction=-1,
                       name="Economic\nHardship Index", na.value="grey40") +
...
p_bi <- ggplot(bi_data) +
  ...
  theme_urbn_dash(base_size=11) +
  labs(title    = "Economic Hardship × Renter Rate",
...
p_legend <- bi_legend(pal="DkBlue", dim=3,
                       xlab="Economic Hardship →", ylab="% Renter →", size=9)
...
ggplot(change_df) +
  ...
  scale_fill_manual(values=lisa_colors,
    ...
    name="LISA Cluster\n(2019, p<0.05)") +
  theme_urbn_dash(base_size=11) +
  labs(title    = paste0("Spatial Economic Hardship Clusters: ", TARGET_LABEL),
...
ggplot(change_df) +
  ...
  scale_fill_manual(values=traj_colors,
    ...
    name="Trajectory\n(2013→2019)") +
  theme_urbn_dash(base_size=11) +
  labs(title    = paste0("Neighborhood Economic Hardship Trajectories: ", TARGET_LABEL),
...
#| label: vb-persistent
#| content: valuebox
list(title="Persistently High Economic Hardship", value=paste0(pct_persist_hh,"%"),
...
ggplot(change_df) +
  ...
  labs(title    = paste0("Economic Hardship Change (2013→2019): ", TARGET_LABEL),
