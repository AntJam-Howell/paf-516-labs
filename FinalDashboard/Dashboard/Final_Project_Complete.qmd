...
maplibre(
  ...
  add_tooltip("NAME", "hardship_index")
```
...
cat(glue::glue(
  ...
  <p style="font-size:0.82rem;color:#333;margin-top:8px">
  {az_top$County} County has the highest economic hardship among Arizona\'s 15 counties. This reflects a combination of persistent rural poverty, limited employment opportunities outside of seasonal industries, and the presence of tribal lands where federal underinvestment has compounded economic disadvantage across generations.</p>'
))
```
...
cat(glue::glue(
  ...
  <p style="font-size:0.82rem;color:#333;margin-top:8px">
  {az_bottom$County} County ranks as Arizona\'s least economically distressed county. Its lower hardship score reflects a diversified employment base, higher median household incomes, and proximity to metro-area economic opportunities that buffer against the structural disadvantages seen in the state\'s rural counties.</p>'
))
```
