...
maplibre(
  ...
  htmlwidgets::onRender("
    function(el, x) {
      ...
      var leg = document.createElement('div');
      leg.style.cssText = 'position:absolute;bottom:32px;left:12px;background:rgba(15,15,15,0.82);color:#e8e8e8;font-size:9px;font-family:Lato,sans-serif;padding:6px 8px;border-radius:5px;line-height:1.7;min-width:170px;';
      var title = document.createElement('div');
      title.style.cssText = 'font-weight:700;font-size:9.5px;margin-bottom:7px;color:#ffffff;border-bottom:1px solid #444;padding-bottom:5px;';
      ...
      entries.forEach(function(e) {
        ...
        swatch.style.cssText = 'display:inline-block;width:9px;height:9px;border-radius:2px;margin-right:8px;flex-shrink:0;background:' + e.color + ';';
...
az_county_hetero_tbl <- az_tract_2023 %>%
  ...
  arrange(`EHI Mean`) %>%      # Better-off (most negative) first
...
az_county_hetero_tbl %>%
  DT::datatable(
      ...
      table(
        ...
        thead(
          tr(
            ...
            th(rowspan = 2, style = "text-align:center;border-left:2px solid #ccc;padding-left:8px;",
               "EH Index (Mean)")
          ),
          tr(
    ...
    caption = htmltools::tags$caption(
      ...
      "Sorted best-off to worst-off by mean EH Index. SD = within-county variation."
    )
  ) %>%
...
#| output: asis
cat(paste0('
<div style="background:#a93226;border-radius:8px;padding:18px 20px;color:#fff;height:100%;display:flex;gap:14px;align-items:flex-start;">
  <span style="font-size:28px;line-height:1;">🔥</span>
  <div>
    <div style="font-size:32px;font-weight:700;line-height:1.1;">', az_n_hh, '</div>
    <div style="font-size:11px;color:#e8c4c0;margin-top:4px;">census tracts statewide</div>
    <div style="font-size:12px;font-weight:600;margin-top:6px;">Hot Spot Clusters (HH)</div>
  </div>
</div>
'))
```
...
#| output: asis
cat(paste0('
<div style="background:#2471a3;border-radius:8px;padding:18px 20px;color:#fff;height:100%;display:flex;gap:14px;align-items:flex-start;">
  <span style="font-size:28px;line-height:1;">❄️</span>
  <div>
    <div style="font-size:32px;font-weight:700;line-height:1.1;">', az_n_ll, '</div>
    <div style="font-size:11px;color:#bdd8ec;margin-top:4px;">census tracts statewide</div>
    <div style="font-size:12px;font-weight:600;margin-top:6px;">Cold Spot Clusters (LL)</div>
  </div>
</div>
'))
```
...
maplibre(
  ...
  htmlwidgets::onRender("
    function(el, x) {
      ...
      var leg = document.createElement('div');
      leg.style.cssText = 'position:absolute;top:12px;left:12px;background:rgba(15,15,15,0.82);color:#e8e8e8;font-size:9px;font-family:Lato,sans-serif;padding:6px 8px;border-radius:5px;line-height:1.7;min-width:170px;';
      var title = document.createElement('div');
      title.style.cssText = 'font-weight:700;font-size:9.5px;margin-bottom:7px;color:#ffffff;border-bottom:1px solid #444;padding-bottom:5px;';
...
list(title = "Persistently High Hardship (2013\u20132019)",
     ...
     icon  = "exclamation-circle", color = "#8b1a1a")
```
...
list(title = "Emerging Hot Spots (2013\u20132019)",
     ...
     icon  = "arrow-up-right-circle", color = "danger")
```
