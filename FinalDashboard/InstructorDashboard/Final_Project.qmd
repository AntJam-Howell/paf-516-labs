...
cat(paste0(
  ...
  '<div>',
  '<div style="font-size:52px;font-weight:700;line-height:1;margin-top:6px;',
  'text-shadow:0 2px 6px rgba(0,0,0,0.2);">', az_n_hh, '</div>',
  '<div style="font-size:12px;color:#e8c4c0;margin-top:5px;letter-spacing:0.02em;">',
  ...
  '<div>',
  '<div style="font-size:52px;font-weight:700;line-height:1;margin-top:6px;',
  'text-shadow:0 2px 6px rgba(0,0,0,0.2);">', az_n_ll, '</div>',
  '<div style="font-size:12px;color:#bdd8ec;margin-top:5px;letter-spacing:0.02em;">',
  'census tracts statewide</div>',
  '</div>',
  '<div style="font-size:12px;font-weight:700;text-transform:uppercase;',
  'letter-spacing:0.07em;opacity:0.95;margin-top:12px;border-top:1px solid rgba(255,255,255,0.25);',
