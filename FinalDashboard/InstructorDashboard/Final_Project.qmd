...
# HH card — pure block stack, nothing can overlap
  ...
  'text-shadow:0 2px 6px rgba(0,0,0,0.2);margin-bottom:14px;">',
  az_n_hh,
  '<span style="font-size:13px;font-weight:400;color:#e8c4c0;letter-spacing:0.02em;margin-left:10px;">',
  'census tracts statewide</span>',
  '</div>',
  ...
  'text-shadow:0 2px 6px rgba(0,0,0,0.2);margin-bottom:14px;">',
  az_n_ll,
  '<span style="font-size:13px;font-weight:400;color:#bdd8ec;letter-spacing:0.02em;margin-left:10px;">',
  'census tracts statewide</span>',
  '</div>',
  '<div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.07em;',
  'border-top:1px solid rgba(255,255,255,0.25);padding-top:10px;">',
