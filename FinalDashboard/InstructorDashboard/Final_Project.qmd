...
cat(paste0(
  ...
  # HH card — pure block stack, nothing can overlap
  '<div style="background:#a93226;border-radius:10px;padding:18px 20px;color:#fff;',
  'flex:1;box-sizing:border-box;user-select:none;-webkit-user-select:none;">',
  '<div style="font-size:28px;line-height:1;margin-bottom:8px;">&#128293;</div>',
  '<div style="font-size:48px;font-weight:700;line-height:1;',
  'text-shadow:0 2px 6px rgba(0,0,0,0.2);margin-bottom:4px;">', az_n_hh, '</div>',
  '<div style="font-size:11px;color:#e8c4c0;letter-spacing:0.02em;margin-bottom:14px;">',
  'census tracts statewide</div>',
  '<div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.07em;',
  'border-top:1px solid rgba(255,255,255,0.25);padding-top:10px;">',
  'Hot Spot (HH) \u2014 High Hardship Cluster</div>',
  '</div>',

  # LL card — pure block stack
  '<div style="background:#2471a3;border-radius:10px;padding:18px 20px;color:#fff;',
  'flex:1;box-sizing:border-box;user-select:none;-webkit-user-select:none;">',
  '<div style="font-size:28px;line-height:1;margin-bottom:8px;">&#10052;</div>',
  '<div style="font-size:48px;font-weight:700;line-height:1;',
  'text-shadow:0 2px 6px rgba(0,0,0,0.2);margin-bottom:4px;">', az_n_ll, '</div>',
  '<div style="font-size:11px;color:#bdd8ec;letter-spacing:0.02em;margin-bottom:14px;">',
  'census tracts statewide</div>',
  '<div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.07em;',
  'border-top:1px solid rgba(255,255,255,0.25);padding-top:10px;">',
  'Cold Spot (LL) \u2014 Low Hardship Cluster</div>',
  '</div>',
