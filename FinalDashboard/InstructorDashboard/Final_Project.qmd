...
cat(paste0(
  ...
  '<div style="font-size:12px;color:#e8c4c0;letter-spacing:0.02em;white-space:nowrap;">',
  ...
  '<div style="font-size:12px;color:#bdd8ec;letter-spacing:0.02em;white-space:nowrap;">',
  'census tracts statewide</div>',
  '</div>',
  '<div style="font-size:12px;font-weight:700;text-transform:uppercase;',
  'letter-spacing:0.07em;opacity:0.95;margin-top:12px;border-top:1px solid rgba(255,255,255,0.25);',
