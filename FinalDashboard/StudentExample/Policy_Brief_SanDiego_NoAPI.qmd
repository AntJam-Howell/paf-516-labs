---
title: "Economic Hardship in San Diego County, CA"
...
#| label: county-config
TARGET_STATE  <- "CA"
TARGET_COUNTY <- "San Diego"
TARGET_LABEL  <- "San Diego County, CA"
```
...
```{r}
#| label: pull-local
local_raw <- readRDS(url("https://raw.githubusercontent.com/AntJam-Howell/paf-516-labs/main/FinalDashboard/StudentExample/data/sandiego_local_2023_RAW.rds"))
local_2023 <- build_hardship_index(local_raw)
```

```{r}
#| label: pull-temporal
local_2013_raw <- readRDS(url("https://raw.githubusercontent.com/AntJam-Howell/paf-516-labs/main/FinalDashboard/StudentExample/data/sandiego_tract_2013_RAW.rds"))
local_2019_raw <- readRDS(url("https://raw.githubusercontent.com/AntJam-Howell/paf-516-labs/main/FinalDashboard/StudentExample/data/sandiego_tract_2019_RAW.rds"))
local_2016_raw <- readRDS(url("https://raw.githubusercontent.com/AntJam-Howell/paf-516-labs/main/FinalDashboard/StudentExample/data/sandiego_tract_2016_RAW.rds"))
```
