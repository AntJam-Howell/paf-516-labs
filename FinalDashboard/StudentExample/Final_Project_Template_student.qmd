...
maplibre(
  ...
  add_legend(
    ...
    values   = c("Hot Spot (HH)", "Cold Spot (LL)", "High-Low (HL)", "Low-High (LH)", "Not Significant"),
    colors   = c("#db2b27", "#1696d2", "#fdbf11", "#73bfe2", "#d2d2d2"),
    position = "bottom-left"
  )
```
...
maplibre(
  ...
  add_legend(
    ...
    values   = c("Persistent HH", "Emerging HH", "Dissolving HH", "Persistent LL", "Emerging LL", "Spatial Outlier"),
    colors   = c("#db2b27", "#fdbf11", "#fdd870", "#1696d2", "#73bfe2", "#ec008b"),
    position = "top-left"
  )
```
