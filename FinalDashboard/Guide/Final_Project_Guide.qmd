...
4. **Uncomment at least one option** by removing the `#` from one to four lines inside the `STUDENT_COMPONENTS <- c(...)` block. For example, to add renter burden and SNAP receipt:
