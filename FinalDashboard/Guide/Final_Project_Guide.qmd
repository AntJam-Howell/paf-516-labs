...
- [Instructor Dashboard (3-variable baseline reference)](../Dashboard/Final_Project_Template.html){target="_blank"}
- [Student Dashboard QMD (download and edit)](Final_Project_Student.qmd){target="_blank"}
