...
- [Instructor Dashboard (3-variable baseline reference)](https://antjam-howell.github.io/paf-516-labs/Final_Project_Complete.html){target="_blank"}
- [Student Dashboard QMD (download and edit)](https://raw.githubusercontent.com/AntJam-Howell/paf-516-labs/main/FinalDashboard/StudentExample/Final_Project_Student.qmd){target="_blank"}
