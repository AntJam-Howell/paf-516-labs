...
opening it. Rename a copy with your last name before editing — the
original stays as a clean reference. The `../data/` paths in the file
resolve correctly only when opened from inside the `Lab1/` folder.
